...
import {
  schoolOutline, briefcaseOutline, constructOutline
} from 'ionicons/icons';
  ...
  experience = [
    {
      ...
      description: 'Desarrollé una plataforma de consulta de paradas de autobús en tiempo real con +3,500 usuarios activos mensuales. Mejoré la capacidad de respuesta un 40% y reduje el tiempo de carga de 1.8s a 0.9s.',
    ...
    },
    {
      ...
      description: 'Desarrollé sistemas de comercio electrónico e inventario para 5 negocios locales. Implementé autenticación, roles y módulos CRUD utilizados por equipos de 10-20 empleados.',
